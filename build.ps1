...
try {
    ...
    if ($IsWindows) {
        if ($Compiler -eq 0) {
            ...
            C:/msys64/mingw64/bin/g++.exe -std=c++20 $OOption $WallOption -I$IncludePath -o"./output/$OutFilename" "$LocationPath/src/main.cpp" -g
        } else {
